...
import org.eclipse.che.plugin.convertigo.graphiceditors.ide.MyResources;
...
@ExtensionGinModule
public class GraphicsEditorsGinModule extends AbstractGinModule {
    ...
    protected FileType provideSequenceFile() {
        return new FileType(MyResources.INSTANCE.icon(), GraphicEditorsExtension.SEQUENCE_EDITOR_EXTENSION);
    }
    ...
    protected FileType provideSqlConnectorFile() {
        return new FileType(MyResources.INSTANCE.icon(), GraphicEditorsExtension.SQL_CONNECTOR_EDITOR_EXTENSION);
    }
}
