...
public class JavelinConnectorEditorProvider extends AbstractGraphicEditor {

    @Inject
    public JavelinConnectorEditorProvider(Provider<GraphicEditorsViewPresenter> graphicEditorsViewPesenter) {
        super(graphicEditorsViewPesenter, "javelinConnectorEditor", "Javelin Connector Editor");
    }
}
