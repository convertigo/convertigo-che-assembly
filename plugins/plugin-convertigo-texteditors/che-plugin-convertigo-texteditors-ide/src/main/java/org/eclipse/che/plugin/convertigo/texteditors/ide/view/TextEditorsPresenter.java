...
@Singleton
public class TextEditorsPresenter extends BasePresenter implements TextEditors.ActionDelegate, FileEventHandler {
    ...
    private native void exportOpenEditor() /*-{
		...
		$wnd.CheGWTOpenTextEditor = function (filePath, qname) {
    		that.@org.eclipse.che.plugin.convertigo.texteditors.ide.view.TextEditorsPresenter::openEditor(Ljava/lang/String;Ljava/lang/String;)(filePath, qname);
		};
	}-*/;
	...
	public void go(AcceptsOneWidget container) {
		container.setWidget(textEditors);
	}
